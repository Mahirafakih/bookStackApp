  ...
  return (
    <div
      className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 z-50 ${
        sticky
          ? "sticky-navbar shadow-md bg-base-300 duration-300 transition-all ease-in-out dark:bg-slate-700"
          : ""
      }`}
    >
        ...
        <div className="navbar-end space-x-3">
          <div className="navbar-center hidden lg:flex">
            ...
            <div className="hidden md:block ">
              <label className=" mr-2 input input-bordered flex items-center gap-2">
